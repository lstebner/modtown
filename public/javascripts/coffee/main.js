...
(function() {
  var Alert, Block, Calendar, ErrorAlert, Factory, Farm, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, StateManager, Street, Structure, Time, Timer, Town, WorldClock, _auto_id, _next_id, _ref, _ref1, _ref2, _ref3,
  ...
  */
  ...
  Housing = (function(_super) {
    ...
    Housing.prototype.begin_construction = function() {
      this.construction_time = WorldClock.get_duration(10, 'seconds');
