...
(function() {
  var Alert, Block, BuildMenu, Calendar, Confirm, Crop, DeliveryTruck, ErrorAlert, Factory, Farm, FloatingMenu, FluxMenu, FundsNotAvailableAlert, HUD, HireWorkersMenu, Housing, ModTownGame, Overlay, Player, Popup, RenderedObject, Resident, ResidentMenu, SelectCropMenu, SelectHouseMenu, SelectJobMenu, StateManager, Street, Structure, StructureMenu, Timer, Town, VisitorMenu, Warehouse, WeatherSystem, WorldClock, crop, key, pin, some_crop_menu_items, some_crops, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1, _ref2, _ref3,
  ...
  */
  ...
  DeliveryTruck = (function() {
    ...
    DeliveryTruck.prototype.begin_unloading = function() {
      return this.state.change_state('unloading');
    };

    DeliveryTruck.prototype.is_full = function() {
      return this.total_stored === this.capacity;
    };
