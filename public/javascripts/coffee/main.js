...
(function() {
  var Address, Alert, Block, BuildMenu, Calendar, Confirm, Crop, DeliveryTruck, ErrorAlert, Factory, Farm, FloatingMenu, FluxMenu, FundsNotAvailableAlert, GPS, HUD, HireWorkersMenu, Housing, ModTownGame, Overlay, Player, Popup, RenderedObject, Resident, ResidentMenu, SelectCropMenu, SelectHouseMenu, SelectJobMenu, StateManager, StateObject, Storage, Street, Structure, StructureMenu, Timer, Town, VisitorMenu, Warehouse, WeatherSystem, WorldClock, crop, key, pin, some_crop_menu_items, some_crops, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1, _ref2, _ref3,
  ...
  */
  ...
  Storage = (function() {
    ...
    Storage.prototype.store_items = function(type, amount, all_or_nothing) {
      var can_fit, remaining, return_amount, _ref;
      if (amount == null) {
        amount = 1;
      }
      ...
      if (this.can_fit_items(amount)) {
        ...
        _ref = this.how_many_can_fit(amount), can_fit = _ref[0], remaining = _ref[1];
    ...
    Storage.prototype.retrieve_items = function(type, amount) {
      var retrieved_items, total_retrieved, types, _i, _len;
      if (type == null) {
        type = 'all';
      }
      if (amount == null) {
    ...
    Storage.prototype.take_items_from = function(storage, type, amount) {
      var count, items, key, total_amount, _ref;
      if (type == null) {
        type = 'all';
      }
      if (amount == null) {
      ...
      _ref = storage.retrieve_items('all', amount), items = _ref[0], total_amount = _ref[1];
  ...
  StateManager = (function() {
    ...
    StateManager.prototype.trigger = function(event_name, data) {
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        fn = _ref3[_i];
        _results.push(fn.apply(this, data));
      }
      return _results;
    };
      ...
      return this.container.on('click', function(e) {
        ...
        switch ($el.data('action')) {
          ...
          case 'request_warehouse_pickup':
            ...
            structure = _this.get_structure(structure_id);
            console.log(structure, _.has(_this.structures_by_type, 'warehouse'));
  ...
  */
  ...
  Block = (function(_super) {
    ...
    Block.prototype.build_structure = function(type, address) {
      if (address == null) {
        address = null;
      }
      switch (type) {
        case 'housing':
          this.build_housing(address);
          break;
        case 'farm':
          this.build_farm(address);
          break;
        case 'factory':
          this.build_factory(address);
          break;
        case 'warehouse':
          this.build_warehouse(address);
      }
  ...
  */
  ...
  DeliveryTruck = (function(_super) {
    ...
    function DeliveryTruck(opts) {
      ...
      this.state.on('state_changed', function(current, previous) {
