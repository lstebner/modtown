...
(function() {
  var Alert, Block, BuildMenu, Calendar, Crop, ErrorAlert, Factory, Farm, FloatingMenu, FluxMenu, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, ResidentMenu, SelectCropMenu, SelectHouseMenu, SelectJobMenu, StateManager, Street, Structure, Timer, Town, VisitorMenu, WeatherSystem, WorldClock, crop, key, pin, some_crop_menu_items, some_crops, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1,
  ...
  */
  ...
  Town = (function(_super) {
    ...
    Town.prototype.setup_events = function() {
      var _this = this;
      return this.container.on('click', function(e) {
        var $el, build_menu, resident, resident_menu, visitor_menu;
        e.preventDefault();
        $el = $(e.target);
        switch ($el.data('action')) {
