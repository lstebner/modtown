...
(function() {
  var Alert, Block, Calendar, ErrorAlert, Factory, Farm, FloatingMenu, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, StateManager, Street, Structure, Time, Timer, Town, WorldClock, _auto_id, _next_id, _ref, _ref1, _ref2,
  ...
  FloatingMenu = (function(_super) {
    ...
    FloatingMenu.prototype.setup_events = function() {
      ...
      return this.container.on('click', function(e) {
        ...
        return _this.trigger($el.data('action'));
      });
    };
    ...
    FloatingMenu.prototype.trigger = function(event_name) {
      return this.container.trigger('item_selected', event_name);
    };
