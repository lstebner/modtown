...
(function() {
  var Alert, Block, BuildMenu, Calendar, ErrorAlert, Factory, Farm, FloatingMenu, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, StateManager, Street, Structure, Time, Timer, Town, WorldClock, _auto_id, _next_id, _ref, _ref1, _ref2,
  ...
  */
  ...
  Town = (function(_super) {
    ...
    Town.prototype.setup_events = function() {
      var _this = this;
      return this.container.on('click', function(e) {
        var $el, block_id, build_menu, street_id;
        e.preventDefault();
        $el = $(e.target);
        switch ($el.data('action')) {
          ...
          case 'launch_build_menu':
            ...
            return build_menu.container.one('item_selected', function(e, selection) {
              switch (selection) {
                case 'build_farm':
                  _this.build_structure('farm', street_id, block_id);
                  break;
                case 'build_factory':
                  _this.build_structure('factory', street_id, block_id);
                  break;
                case 'build_housing':
                  _this.build_structure('housing', street_id, block_id);
              }
              build_menu.destroy();
              return $el.hide();
            });
