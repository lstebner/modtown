...
(function() {
  var Alert, Block, BuildMenu, Calendar, ErrorAlert, Factory, Farm, FloatingMenu, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, ResidentMenu, SelectHouseMenu, StateManager, Street, Structure, Time, Timer, Town, VisitorMenu, WorldClock, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1, _ref2,
  ...
  */
  ...
  Structure = (function(_super) {
    ...
    Structure.prototype.begin_construction = function(clock) {
      ...
      this.construction_timer = clock.create_timer(this.construction_time, function() {
  ...
  */
  ...
  Farm = (function(_super) {
    ...
    function Farm() {
      _ref1 = Farm.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    Farm.prototype.begin_construction = function() {
      this.construction_time = WorldClock.duration(5, 'minutes');
