...
(function() {
  var Alert, Block, Calendar, ErrorAlert, Factory, Farm, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, StateManager, Street, Structure, Time, Town, WorldClock, _ref, _ref1, _ref2, _ref3,
  ...
  */
  ...
  WorldClock = (function() {
    ...
    WorldClock.prototype.update = function() {
      ...
      return this.year = Math.floor(this.since_epoch / WorldClock.seconds_in_year);
    };
  ...
  */
  ...
  Structure = (function(_super) {
    ...
    Structure.prototype.progress_construction = function() {
      this.construction_time_remaining = this.construction_time - (Time.now() - this.construction_started);
    ...
    Structure.prototype.begin_construction = function() {
      ...
      this.construction_started = Time.now();
      ...
      switch (this.state.current()) {
        case 'under_construction':
          vdata = {
            ...
            construction_percent_complete: this.construction_time_remaining / this.construction_time,
  ...
  */
  ...
  Farm = (function(_super) {
    ...
    Farm.prototype.begin_construction = function() {
      this.construction_time = Time.in_millis(5, 'minutes');
