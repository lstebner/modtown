...
(function() {
  var Alert, Block, BuildMenu, Calendar, Crop, ErrorAlert, Factory, Farm, FloatingMenu, FundsNotAvailableAlert, HUD, Housing, ModTownGame, Player, RenderedObject, Resident, ResidentMenu, SelectCropMenu, SelectHouseMenu, StateManager, Street, Structure, Time, Timer, Town, VisitorMenu, WeatherSystem, WorldClock, crop, key, pin, some_crop_menu_items, some_crops, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1,
    ...
    Farm.prototype.setup_events = function() {
      ...
      return this.container.on('click', function(e) {
        ...
        switch ($el.data('action')) {
          ...
          case 'start_planting':
            return _this.state.change_state('start_planting');
        }
      });
    };
