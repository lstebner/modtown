...
(function() {
  var Address, Alert, Block, BuildMenu, Calendar, Confirm, Crop, DeliveryTruck, ErrorAlert, Factory, Farm, FloatingMenu, FluxMenu, FundsNotAvailableAlert, GPS, HUD, HireWorkersMenu, Housing, ModTownGame, Overlay, Player, Popup, RenderedObject, Resident, ResidentMenu, SelectCropMenu, SelectHouseMenu, SelectJobMenu, StateManager, StateObject, Street, Structure, StructureMenu, Timer, Town, VisitorMenu, Warehouse, WeatherSystem, WorldClock, crop, key, pin, some_crop_menu_items, some_crops, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1, _ref2, _ref3,
  ...
  */
  ...
  RenderedObject = (function(_super) {
    __extends(RenderedObject, _super);
  ...
  */
  ...
  Overlay = (function(_super) {
    ...
    Overlay.prototype.show = function() {
      ...
      return this.container.addClass('transitioning').fadeIn(function() {
      ...
      if (this.town && event_name === 'item_selected') {
        switch (value) {
          ...
          case 'build_housing':
            ...
            break;
          case 'build_warehoue':
            this.town.build_structure('warehouse', this.street_id, this.block_id);
        }
        return this.destroy();
      }
    };
  ...
  */
  ...
  FluxMenu = (function(_super) {
    ...
    FluxMenu.prototype.add_one_hour = function() {
      var _ref1;
      return (_ref1 = this.clock) != null ? _ref1.add_time(1, 'hours') : void 0;
    };

    FluxMenu.prototype.pause_time = function() {
      var _ref1;
      return (_ref1 = this.clock) != null ? _ref1.pause_time() : void 0;
    };

    FluxMenu.prototype.resume_time = function() {
      var _ref1;
      return (_ref1 = this.clock) != null ? _ref1.resume_time() : void 0;
    };

    FluxMenu.prototype.speed_up_time = function() {
      var _ref1;
      return (_ref1 = this.clock) != null ? _ref1.time_speed_plus() : void 0;
    };

    FluxMenu.prototype.slow_down_time = function() {
      var _ref1;
      return (_ref1 = this.clock) != null ? _ref1.time_speed_minus() : void 0;
    };

    FluxMenu.prototype.default_time = function() {
      var _ref1;
      return (_ref1 = this.clock) != null ? _ref1.time_speed_default() : void 0;
    };
  ...
  */
  ...
  ResidentMenu = (function(_super) {
    ...
    ResidentMenu.prototype.setup_jobs_menu = function() {
      var i, job, job_items, _i, _len, _ref1,
        _this = this;
      job_items = {};
      _ref1 = this.available_jobs;
  ...
  VisitorMenu = (function(_super) {
    ...
    VisitorMenu.prototype.move_in_to_town = function() {
      ...
      return this.select_house_menu.container.one('house_selected', function(e, house_id) {
        var house, _i, _len, _ref1, _results;
  ...
  */
  ...
  /* --------------------------------------------
       Begin StructureMenu.coffee
  --------------------------------------------
  */


  StructureMenu = (function(_super) {
    __extends(StructureMenu, _super);

    function StructureMenu() {
      _ref1 = StructureMenu.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  */
  ...
  HUD = (function(_super) {
    ...
    function HUD() {
      _ref2 = HUD.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  */
  ...
  StateManager = (function() {
    ...
    StateManager.prototype.trigger = function(event_name, data) {
      ...
      _ref3 = this.bindings[event_name];
      _results = [];
  ...
  */
  ...
  Town = (function(_super) {
    ...
    Town.prototype.update = function(clock) {
      var r, s, _i, _j, _len, _len1, _ref3, _ref4;
      _ref3 = this.streets;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        s = _ref3[_i];
        s.update(clock);
      }
      _ref4 = this.residents;
    ...
    Town.prototype.remove_visitor = function(id) {
      var v, visitors_cleaned, _i, _len, _ref3;
      visitors_cleaned = [];
      _ref3 = this.visitors;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        v = _ref3[_i];
    ...
    Town.prototype.get_occupancy_percent = function() {
      var idx, structure_ids, total, _i, _len, _ref3;
      ...
      for (_i = 0, _len = structure_ids.length; _i < _len; _i++) {
        ...
        total += (_ref3 = this.structures[idx]) != null ? _ref3.occupancy_percent() : void 0;
      }
    ...
    Town.prototype.get_available_jobs = function() {
      var jobs, s, _i, _len, _ref3;
      jobs = [];
      _ref3 = this.structures;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        s = _ref3[_i];
    ...
    Town.prototype.get_available_workers = function() {
      var r, workers, _i, _len, _ref3;
      workers = [];
      _ref3 = this.residents;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        r = _ref3[_i];
        if (!r.is_employed()) {
          workers.push(r);
  ...
  */
  ...
  Street = (function(_super) {
    ...
    Street.prototype.setup_blocks = function() {
      var i, _i, _ref3;
      for (i = _i = 1, _ref3 = this.opts.blocks; 1 <= _ref3 ? _i <= _ref3 : _i >= _ref3; i = 1 <= _ref3 ? ++_i : --_i) {
        this.create_block();
      }
  ...
  */
  ...
  Block = (function(_super) {
    ...
    Block.prototype.build_warehouse = function() {
      return this.structure = new Warehouse(this.container.find('.structure'));
    };
    ...
    Block.prototype.setup_settings_menu = function() {
      ...
      return this.settings_menu.container.on('item_selected', function(e, value) {
  ...
  */
  ...
  Resident = (function(_super) {
    ...
    function Resident() {
      ...
      this.house_id = (_ref3 = this.house) != null ? _ref3.id : void 0;
  ...
  */
  ...
  Structure = (function(_super) {
    ...
    Structure.prototype.fire_resident = function(id) {
      var e, key, r, remove_key, _i, _len, _ref3, _ref4;
      remove_key = -1;
      _ref3 = this.employees;
      ...
      if (remove_key > -1) {
        ...
        return (_ref4 = e[0]) != null ? _ref4.set_employer(null) : void 0;
      }
    };
  ...
  */
  ...
  Farm = (function(_super) {
    ...
    Farm.prototype.growing = function(clock) {
      var c, total_growth_percent, _i, _len, _ref3;
      total_growth_percent = 0;
      _ref3 = this.planted_crops;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        c = _ref3[_i];
        c.update(clock);
  ...
  */
  ...
  _next_house_name = function() {
    var i, letter, letters, _i, _ref4;
    letter = _house_ids[_house_idx % _house_ids.length];
    letters = "";
    for (i = _i = 0, _ref4 = Math.floor(_house_idx / _house_ids.length) + 1; 0 <= _ref4 ? _i < _ref4 : _i > _ref4; i = 0 <= _ref4 ? ++_i : --_i) {
      letters += letter;
    }
    _house_idx += 1;
  ...
  Housing = (function(_super) {
    ...
    Housing.prototype.move_resident_out = function(resident) {
      var r, residents_new, _i, _len, _ref4;
      if (this.occupants === 0) {
        return;
      }
      this.occupants -= 1;
  ...
  /* --------------------------------------------
       Begin DeliveryTruck.coffee
  --------------------------------------------
  */


  DeliveryTruck = (function(_super) {
    __extends(DeliveryTruck, _super);
    ...
    DeliveryTruck.prototype.begin_loading = function() {
      ...
      return this.state_timer.set_duration(100);
    };

    DeliveryTruck.prototype.begin_unloading = function() {
      this.state.change_state('unloading');
      return this.state_timer.set_duration(this.total_stored * 10);
    };

    DeliveryTruck.prototype.is_full = function() {
      return this.total_stored === this.actual_capacity();
    };

    DeliveryTruck.prototype.is_empty = function() {
      return this.total_stored === 0;
    };
    ...
    DeliveryTruck.prototype.park = function() {
      return this.state.change_state('parked');
    };
    ...
    DeliveryTruck.prototype.set_destination = function(destination, is_address, start_driving) {
      ...
      this.state_timer.set_duration(World.gps.get_travel_time_between(this.current_location, this.destination_address, this.drive_speed));
    ...
    DeliveryTruck.prototype.return_to_warehouse = function() {
      ...
      return this.set_destination(this.warehouse_address, true);
    };

    DeliveryTruck.prototype.driving = function() {
      this.state_timer.update();
      if (this.state_timer.is_complete()) {
        if (this.is_at_destination()) {
          return this.begin_loading();
        } else if (this.is_at_warehouse()) {
  ...
  */
  ...
  Warehouse = (function(_super) {
    ...
    Warehouse.prototype.setup_delivery_trucks = function() {
      var i, new_truck, _i, _ref4, _results;
      _results = [];
      for (i = _i = 1, _ref4 = this.num_trucks; 1 <= _ref4 ? _i <= _ref4 : _i >= _ref4; i = 1 <= _ref4 ? ++_i : --_i) {
    ...
    Warehouse.prototype.assign_driver = function(truck) {
      var employee, _i, _len, _ref4;
      if (truck.has_driver()) {
        return truck;
      }
      _ref4 = this.employees;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        employee = _ref4[_i];
    ...
    Warehouse.prototype.store = function(what, how_many) {
      if (!_.has(this.storage, what)) {
        this.storage[what] = 0;
      }
      this.storage[what] += how_many;
      return this.check_storage_capacity();
    };

    Warehouse.prototype.check_storage_capacity = function() {
      var amount, _i, _len, _ref4;
      this.total_stored = 0;
      _ref4 = this.storage;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        amount = _ref4[_i];
        this.total_stored += amount;
      }
      if (this.is_over_capacity()) {
        return this.state.change_state('over capacity');
      }
    };
