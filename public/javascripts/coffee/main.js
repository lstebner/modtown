...
(function() {
  var Alert, Block, BuildMenu, Calendar, Confirm, Crop, DeliveryTruck, ErrorAlert, Factory, Farm, FloatingMenu, FluxMenu, FundsNotAvailableAlert, HUD, HireWorkersMenu, Housing, ModTownGame, Overlay, Player, Popup, RenderedObject, Resident, ResidentMenu, SelectCropMenu, SelectHouseMenu, SelectJobMenu, StateManager, Street, Structure, Timer, Town, VisitorMenu, Warehouse, WeatherSystem, WorldClock, crop, key, pin, some_crop_menu_items, some_crops, _auto_id, _house_ids, _house_idx, _next_house_name, _next_id, _ref, _ref1, _ref2,
  ...
  */
  ...
  HUD = (function(_super) {
    ...
    function HUD() {
      _ref1 = HUD.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  */
  ...
  StateManager = (function() {
    ...
    StateManager.prototype.trigger = function(event_name, data) {
      ...
      _ref2 = this.bindings[event_name];
      _results = [];
  ...
  */
  ...
  Town = (function(_super) {
    ...
    Town.prototype.update = function(clock) {
      var r, s, _i, _j, _len, _len1, _ref2, _ref3;
      _ref2 = this.streets;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        s = _ref2[_i];
        s.update(clock);
    ...
    Town.prototype.remove_visitor = function(id) {
      var v, visitors_cleaned, _i, _len, _ref2;
      visitors_cleaned = [];
      _ref2 = this.visitors;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        v = _ref2[_i];
    ...
    Town.prototype.get_occupancy_percent = function() {
      var idx, structure_ids, total, _i, _len, _ref2;
      ...
      for (_i = 0, _len = structure_ids.length; _i < _len; _i++) {
        ...
        total += (_ref2 = this.structures[idx]) != null ? _ref2.occupancy_percent() : void 0;
      }
    ...
    Town.prototype.get_available_jobs = function() {
      var jobs, s, _i, _len, _ref2;
      jobs = [];
      _ref2 = this.structures;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        s = _ref2[_i];
  ...
  */
  ...
  Street = (function(_super) {
    ...
    Street.prototype.setup_blocks = function() {
      var i, _i, _ref2;
      for (i = _i = 1, _ref2 = this.opts.blocks; 1 <= _ref2 ? _i <= _ref2 : _i >= _ref2; i = 1 <= _ref2 ? ++_i : --_i) {
        this.create_block();
      }
  ...
  */
  ...
  Resident = (function(_super) {
    ...
    function Resident() {
      ...
      this.house_id = (_ref2 = this.house) != null ? _ref2.id : void 0;
  ...
  */
  ...
  Structure = (function(_super) {
    ...
    Structure.prototype.fire_resident = function(id) {
      var e, key, r, remove_key, _i, _len, _ref2, _ref3;
      remove_key = -1;
      _ref2 = this.employees;
      ...
      if (remove_key > -1) {
        ...
        return (_ref3 = e[0]) != null ? _ref3.set_employer(null) : void 0;
      }
    };
  ...
  */
  ...
  Farm = (function(_super) {
    ...
    Farm.prototype.growing = function(clock) {
      var c, total_growth_percent, _i, _len, _ref2;
      total_growth_percent = 0;
      _ref2 = this.planted_crops;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        c = _ref2[_i];
        c.update(clock);
  ...
  */
  ...
  Factory = (function(_super) {
    ...
    function Factory() {
      _ref2 = Factory.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  */
  ...
  _next_house_name = function() {
    var i, letter, letters, _i, _ref3;
    letter = _house_ids[_house_idx % _house_ids.length];
    letters = "";
    for (i = _i = 0, _ref3 = Math.floor(_house_idx / _house_ids.length) + 1; 0 <= _ref3 ? _i < _ref3 : _i > _ref3; i = 0 <= _ref3 ? ++_i : --_i) {
      letters += letter;
    }
    _house_idx += 1;
  ...
  Housing = (function(_super) {
    ...
    Housing.prototype.move_resident_out = function(resident) {
      var r, residents_new, _i, _len, _ref3;
      if (this.occupants === 0) {
        return;
      }
      this.occupants -= 1;
  ...
  */
  ...
  Warehouse = (function(_super) {
    ...
    Warehouse.prototype.setup_delivery_trucks = function() {
      var i, new_truck, _i, _ref3, _results;
      _results = [];
    ...
    Warehouse.prototype.goto_next_delivery = function() {
    ...
    Warehouse.prototype.goto_next_pickup = function() {
